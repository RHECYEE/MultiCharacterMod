...
public final class ClientStrategicCache {
    ...
    public static int[] citizenDots() { return citizenDots; }
    ...
    public static boolean evacActive() { return evacActive; }
